...
def sub_kernel(
    ...
    """Element-wise subtraction kernel with extended autotune."""
    pid = tl.program_id(0)
    ...
    # Perform subtraction (fused operation)
    result = a - b
...
def solve(a: torch.Tensor, b: torch.Tensor) -> torch.Tensor:
    """Wrapper function to call the optimized sub kernel.
